...
This small library is supposed to make it possible to easily add warnings to methods that you need to remember
to update at some point in the future. Think of it as executable comments with a timer :)
